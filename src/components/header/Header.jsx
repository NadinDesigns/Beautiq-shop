      ...
      <div className="container">
        <div className="header-box">
            ...
            >
              <g>
                <g>
                  <g>
                    <path
                      d="M468.884,439.242V180.547c0-4.466-3.618-8.084-8.084-8.084c-4.466,0-8.084,3.619-8.084,8.084v258.695
                                                          c0,4.466,3.619,8.084,8.084,8.084C465.266,447.326,468.884,443.708,468.884,439.242z"
                    />
                    <path
                      d="M185.937,388.042h-75.453c-16.345,0-29.642,13.298-29.642,29.642v64.674c0,4.848,1.171,9.429,3.242,13.474H45.811
                    ...
                    />
                    <path
                      d="M18.863,495.832H8.084C3.62,495.832,0,499.45,0,503.916C0,508.382,3.62,512,8.084,512h10.779
                                                          c4.465,0,8.084-3.618,8.084-8.084C26.947,499.45,23.328,495.832,18.863,495.832z"
                    />
                    <path
                      d="M439.242,97.011h-10.779V29.642C428.463,13.298,415.165,0,398.821,0h-37.726c-16.344,0-29.642,13.298-29.642,29.642
                    ...
                    />
                    <path
                      d="M285.642,312.589h-2.695v-99.705c0-16.344-13.298-29.642-29.642-29.642h-21.558c-16.345,0-29.642,13.298-29.642,29.642
                    ...
                    />
                    <path
                      d="M296.421,460.8v-97.01c0-4.466-3.619-8.084-8.084-8.084c-4.466,0-8.084,3.618-8.084,8.084v97.01
          ...
          <div className="header-controls">
            <button className="btn btn-outline">Anmelden/Registrieren</button>
